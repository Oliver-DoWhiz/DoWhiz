...
Use these first when the answer affects tax classification, filing obligation, treaty interpretation, or unusual entity treatment.

| Source | What to use it for | URL |
| --- | --- | --- |
| Internal Revenue Code, section 7701 and related definitions | Statutory definitions of resident, nonresident, domestic, foreign, corporation, partnership, and related terms | https://uscode.house.gov/view.xhtml?req=%28title%3A26+section%3A7701%29 |
| Treasury regulations under section 7701(b) | Technical residency rules, days of presence, start and end dates, treaty coordination | https://www.ecfr.gov/current/title-26/chapter-I/subchapter-F/part-301/subpart-ECFR5ffaf3310af6b61 |
...
| Source | What to use it for | URL |
| --- | --- | --- |
| About Form W-2 | Wage and tax statement details | https://www.irs.gov/forms-pubs/about-form-w-2 |
| About Form 1099-NEC | Nonemployee compensation details | https://www.irs.gov/forms-pubs/about-form-1099-nec |
| About Form 1099-MISC | Miscellaneous income details | https://www.irs.gov/forms-pubs/about-form-1099-misc |
| About Form 1042-S | Foreign-person income subject to withholding | https://www.irs.gov/forms-pubs/about-form-1042-s |
| Instructions for Form 1042-S | Current-year reporting details for 1042-S | https://www.irs.gov/instructions/i1042s |
| About Form W-7 | ITIN application or renewal | https://www.irs.gov/forms-pubs/about-form-w-7 |
| Topic no. 159 | How to get a wage and income transcript or W-2 copy | https://www.irs.gov/taxtopics/tc159 |
...
Use these only for what the product supports and how signup or filing works in that product.

### Sprintax

- Product and route page for nonresident returns:
...
- Official site search patterns:
  ...
  - `site:sprintax.com create account Sprintax`

### TurboTax and Intuit

- Individual filing product:
...
- Official site search patterns:
  ...
  - `site:intuit.com create account Intuit`
...
- `site:irs.gov "<form or topic>" IRS official`
- `site:irs.gov "<tax year> instructions for form <form number>"`
