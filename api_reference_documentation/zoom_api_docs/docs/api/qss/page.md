...
- Source URL: https://developers.zoom.us/docs/api/qss/
- Snapshot path: docs/api/qss
- Generated (UTC): 2026-02-07T22:40:11.469030+00:00
        ...
        "flows": {
          "authorizationCode": {
            ...
            "scopes": {
              ...
              "dashboard:read:list_meeting_participants_qos:admin": "dashboard:read:list_meeting_participants_qos:admin",
              "dashboard_webinars:read:admin": "dashboard_webinars:read:admin",
              "dashboard:read:list_webinar_participants_qos:admin": "dashboard:read:list_webinar_participants_qos:admin"
            }
          }
        }
      }
...
```json
{
  ...
  "downloadPath": "/api-hub/qss/methods/endpoints.json",
  "apiOptions": {
    "events": true,
    "methods": true,
    "ma": true
  ...
  "productMeta": {
    "specType": "oas",
    "slug": "/docs/api/rest/reference/qss/methods",
    "title": "Zoom QSS API",
    "description": "",
    "keywords": "zoom, marketplace, qss, qos, api, rest, real-time, quality, service",
    "params": {
    ...
    "postmanLink": "https://www.postman.com/zoom-developer/zoom-public-workspace/collection/ic1ie06/zoom-qss-api",
    "scalarSlug": "/docs/api/qss/methods",
    "svgname": "qss"
  },
  "frontmatter": {
    "title": "QSS APIs",
