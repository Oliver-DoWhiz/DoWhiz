...
- Source URL: https://developers.zoom.us/docs/api/number-management/
- Snapshot path: docs/api/number-management
- Generated (UTC): 2026-02-07T22:40:11.093651+00:00

## Frontmatter

```json
{
  "title": "Number Management APIs",
...
```json
{
  ...
  "paths": {
    ...
    "/number_management/byoc_numbers": {
      "post": {
        "tags": [
          "Phone Numbers"
        ],
    ...
    "/number_management/numbers/{phoneNumberId}": {
      "get": {
        "tags": [
          "Phone Numbers"
        ],
    ...
    "/number_management/sms_consent/{consentId}/phone_numbers": {
      "get": {
        "tags": [
          "SMS Consent"
        ],
...
```json
{
  ...
  "downloadPath": "/api-hub/number-management/methods/endpoints.json",
  "apiOptions": {
    "events": true,
    "methods": true,
    "ma": true
  ...
  "productMeta": {
    "specType": "oas",
    "slug": "/docs/api/rest/reference/number-management/methods",
    "title": "Cloud Peering - Provider Exchange",
    "description": "",
    "keywords": "zoom, rest, api, number managment",
    "params": {
    ...
    "scalarSlug": "/docs/api/number-management/methods",
